  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl bg-black min-h-screen">
      ...
      <div className="text-center mb-10 animate-fade-in">
        <h1 className="text-4xl font-light tracking-wider mb-2 gradient-text">
          DANCE CAMP SCHEDULE
        </h1>
      ...
      <div className="relative min-h-96 bg-black">
        {days.map((day, dayIndex) => (
          <div
            key={dayIndex}
            className={`absolute w-full transition-all duration-500 bg-black ${
              activeDay === dayIndex 
              ...
              >
                <div className="relative z-10">
                  {event.type === 'interview' && (
                    <span className="inline-block w-5 h-5 bg-secondary-500 rounded-full mr-2 text-center text-xs">
                      🎥
                    </span>
                  )}
